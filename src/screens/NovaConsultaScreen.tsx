...
export default function NovaConsultaScreen({
  ...
  async function handleAgendar() {
    ...
    try {
      ...
      Alert.alert(
        "Erro",
        error.message || "Não foi possível agendar a consulta.",
      );
    } finally {
      setLoading(false);
    }
    ...
    >
      ...
      <View style={styles.form}>
        ...
        >
          <Text
            style={
              especialidade ? styles.selectorTexto : styles.selectorPlaceholder
            }
          >
        ...
        <TouchableOpacity
          style={[
            styles.selector,
            !especialidade && styles.selectorDesabilitado,
          ]}
          onPress={() => especialidade && setModalMedico(true)}
        >
          <Text
            style={medico ? styles.selectorTexto : styles.selectorPlaceholder}
          >
            {medico
              ? medico.nome
              : especialidade
        ...
        >
          <Text
            style={horario ? styles.selectorTexto : styles.selectorPlaceholder}
          >
                ...
                >
                  <Text
                    style={[
                      ...
                      especialidade === item &&
                        styles.modalItemTextoSelecionado,
                    ]}
                  >
                    {item}
                  </Text>
